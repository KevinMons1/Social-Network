                ...
                : <div className="account-content">
                    ...
                    <div className={themeReducer ? "account-top-dark" : "account-top"}>
                        <div className="account-bg">
                            <img className="account-bg-img" src={dataUser.bannerImageUrl} alt="Your banner frame"/>
                        </div>
                        <div className="account-info">
                            <div className="account-info-top">
                                <div className={themeReducer ? "account-info-img-dark" : "account-info-img"}>
                                    <img className="img-profile" src={dataUser.profileImageUrl} alt="Your profile frame"/>
                                </div>
                                <div>
                                    <p className={themeReducer ? "txt-dark" : null}>{dataUser.firstName} {dataUser.lastName}</p>
                                </div>
                            ...
                            <div className="account-bottom">
                                <div className="account-icon">
                                    <div className="account-icon-box">
                                        ...
                                        <p className={themeReducer ? "account-icon-nbr-dark" : "account-icon-nbr"}>{dataUser.likesTotal}</p>
                                    </div>
                                    <div className="account-icon-box">
                                        <FontAwesomeIcon icon="user-friends" className="user-friends-icon"/>
                                        <p className={themeReducer ? "account-icon-nbr-dark" : "account-icon-nbr"}>{dataUser.friendsTotal}</p>
                                    </div>
                                    <div className="account-icon-box">
                                        <FontAwesomeIcon icon="pen" className="pen-icon"/>
                                        <p className={themeReducer ? "account-icon-nbr-dark" : "account-icon-nbr"}>{dataUser.publicationsTotal}</p>
                                    </div>
                                </div>
